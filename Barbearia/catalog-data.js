...
const CATALOG = {
  higher: {
    ...
    items: [
      { id: "h1", name: "", image: "", price: 0,    tag: "Novo" },
      { id: "h2", name: "", image: "", price: 0,    tag: "" },
      { id: "h3", name: "", image: "", price: 0,    tag: "" },
      { id: "h4", name: "", image: "", price: 0,    tag: "" },
      { id: "h5", name: "", image: "", price: 0,    tag: "" },
      { id: "h6", name: "", image: "", price: 0,    tag: "" },
  ...
  lower: {
    ...
    items: [
      { id: "l1", name: "", image: "", price: 0,    tag: "Novo" },
      { id: "l2", name: "", image: "", price: 0,    tag: "" },
      { id: "l3", name: "", image: "", price: 0,    tag: "" },
      { id: "l4", name: "", image: "", price: 0,    tag: "" },
      { id: "l5", name: "", image: "", price: 0,    tag: "" },
      { id: "l6", name: "", image: "", price: 0,    tag: "" },
